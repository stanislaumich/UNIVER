...
public class Utiliz extends javax.swing.JFrame {
    ...
    public Utiliz() {
        initComponents();
        setTitle("Организации утилизации");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Utiliz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
