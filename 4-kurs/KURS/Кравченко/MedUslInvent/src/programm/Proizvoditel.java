...
public class Proizvoditel extends javax.swing.JFrame {
    ...
    private void filltable() {
        ...
        try {
            ...
            createtable();
            stmt = conn.createStatement();
            String sql = "select count(*) C from POST";
    ...
    public Proizvoditel() {
        initComponents();
        setTitle("Производители оборудования");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String sql = "update POST set NAME='"
                    + jTextField1.getText() + "', ADDRES='"
                    + jTextField2.getText() + "', DOP='"
                    + jTextField3.getText() + "' where NAME='"
                    + oldName + "'";
            stmt.executeUpdate(sql);
            stmt.close();
            filltable();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            stmt = conn.createStatement();
            //System.out.println(jTable1.getValueAt(i, 0));
            String sql = "delete from POST where NAME='"
                    + jTextField1.getText() + "'";
            stmt.executeUpdate(sql);
            stmt.close();
            filltable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Proizvoditel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Proizvoditel().setVisible(true);
            }
        });
    }
