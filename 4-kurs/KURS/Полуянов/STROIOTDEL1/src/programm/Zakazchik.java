...
public class Zakazchik extends javax.swing.JFrame {
    ...
    private void createtable() {
        ...
        try {
            ...
            String sql = "CREATE TABLE IF NOT EXISTS ZAK ("
    ...
    private void filltable() {
        ...
        try {
            ...
            createtable();
            stmt = conn.createStatement();
            String sql = "select count(*) C from ZAK";
    ...
    public Zakazchik() {
        initComponents();
        setTitle("Заказчики организации");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Наименование", "Адрес", "Реквизиты"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            createtable();
            stmt = conn.createStatement();
            String sql = "insert into ZAK values(NULL,'"
                    + jTextField1.getText() + "', '"
                    + jTextField2.getText() + "', '"
                    + jTextField3.getText() + "')";
            stmt.executeUpdate(sql);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String sql = "update ZAK set NAME='"
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            stmt = conn.createStatement();
            //System.out.println(jTable1.getValueAt(i, 0));
            String sql = "delete from ZAK where NAME='"
                    + jTextField1.getText() + "'";
            stmt.executeUpdate(sql);
            stmt.close();
            filltable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Zakazchik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
