...
public class ZakazList extends javax.swing.JFrame {
...
//if (num > Byte.valueOf(jTextField1.getText())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZakazList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
