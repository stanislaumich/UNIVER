...
public class PostavList extends javax.swing.JFrame {
    ...
    public PostavList() {
        initComponents();
        setTitle("Поставщики организации");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostavList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PostavList().setVisible(true);
            }
        });
    }
