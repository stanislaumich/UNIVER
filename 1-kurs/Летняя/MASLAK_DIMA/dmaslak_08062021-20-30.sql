...
-- Дамп данных таблицы dmaslak.klient: ~7 rows (приблизительно)
DELETE FROM `klient`;
...
-- Создание временной таблицы для обработки ошибок зависимостей представлений
CREATE TABLE `viewb` (
	`naz` VARCHAR(500) NOT NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `viewc` (
	...
	`telefon` VARCHAR(50) NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;
